...
//      0
//      - 2455     -                                    18:00:00
// Dawn - 19810    05:30:10  0               0          00:00:00
//      43200      12:00:00  23390                      -
//      - 45660    -                         43200      06:00:00
// Dusk - 71500    19:51:40  51690                      12:00:00
//      86400 (0)  00:00:00  66590                      -
//      - 106210   -                         86400      18:00:00
...
describe("SiliTime.fromDaySeconds", () => {
  describe("when give a sunrise, sunset, and daySecond", () => {
    it("returns the S.I.L.I. time", () => {
      ...
      const expectedA = SiliTime.toSet({ seg: 0, segen: 0, seget: 0 })
      ...
      const expectedB = SiliTime.toSet({ seg: 6, segen: 0, seget: 0 })
      ...
      const expectedC = SiliTime.toSet({ seg: 12, segen: 0, seget: 0 })
      ...
      const expectedD = SiliTime.toSet({ seg: 13, segen: 14, seget: 34 })
      ...
      const expectedE = SiliTime.toSet({ seg: 18, segen: 0, seget: 0 })
